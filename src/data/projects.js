const projects = [
  {
    ...
    description:
      "Mixed Reality (MR) and Desktop App that redfines math education for students and teachers. It combines technology with interactive learning to create more accessible and engaging math experiences.",
    lastUpdated: "2024",
    developmentTeam: [
      {
        name: "Zack Cornfield",
    ...
    featuresDeveloped: [
      {
        name: "UI",
        description:
          "Designed and implemented an intuitive user interface to ensure ease of use for both teachers and students. The UI includes features like creating, modifying, and managing math modules, along with seamless navigation for interactive learning.",
        image: "./assets/images/MathsPlay/UI1.png",
      },
      {
        name: "Nodes/Backend",
        description:
          "Developed a node-based backend system that serves as the core of the module creation engine. Teachers can use this to build interactive lessons by connecting nodes representing variables, equations, and functions. This modular system makes lesson customization flexible and efficient.",
        image: "./assets/images/MathsPlay/Nodes.png",
      },
      {
        name: "3D Axis System",
        description:
          "Created an optional 3D axis system that can be toggled on node models to aid in visualizing spatial relationships. Includes an interactive menu to toggle grid lines, reset the grid, and adjust settings, enhancing the clarity of 3D visualizations.",
        image: "./assets/images/MathsPlay/3DAxisSystem.png",
      },
      {
        name: "Scene Placement",
        description:
          "Developed a scene placement feature that allows users to position and move 3D vector nodes within the environment. This ensures precise placement and alignment of nodes, making it easier for students to interact with the scene during gameplay.",
  ...
  },
  {
    ...
    description:
      "Simulation recreating a university campus area, showcasing a custom-built game engine.",
    lastUpdated: "2024",
    developmentTeam: [
      {
        name: "Zack Cornfield",
    ...
    featuresDeveloped: [
      {
        ...
        description:
          "Contributed to the mesh rendering process by iterating through all entities with meshes and implementing the logic to render them. Developed the texture manager system for efficient loading and usage of textures, the shader manager for handling shader programs, and the material manager for managing material properties and components. These systems collectively ensure efficient and high-quality rendering within the game engine.",
        image: "./assets/images/MurdochWalkthrough/Environment.png",
      },
      {
        name: "Physics System",
        description:
          "Designed and implemented a custom resolution system with robust support for both linear and angular physics. Developed a collision detection system for precise interactions, ensuring realistic and engaging physics within the simulation.",
        image: "./assets/images/MurdochWalkthrough/Physics.png",
      },
      {
        name: "World Creation/Design",
        description:
          "Collaborated on the creation and design of the world environment, ensuring a realistic and immersive experience for users. Utilized 3D scanning technology to capture and replicate the chosen area within the university campus, enhancing the authenticity and detail of the simulation.",
  ...
  },
  {
    ...
    type: "University Project",
    description:
      "Simple CRUD application for managing magazine subscriptions, showcasing JavaFX and MVC architecture.",
    lastUpdated: "2024",
    developmentTeam: [
      {
        name: "Zack Cornfield",
  ...
  },
  {
    ...
    type: "University/Client Project",
    description:
      "Math Games is an MR and PC game developed using Unity that is aimed at helping teachers and students to both teach and learn the more basic math concepts for those in middle school and similar ages.",
    lastUpdated: "2024",
    developmentTeam: [
      {
        name: "Zack Cornfield",
  ...
  },
  {
    ...
    description:
      "A full-stack social media platform where users can create posts, follow people, like content, and interact with others. Built using React, Node.js, and Express.",
    lastUpdated: "2025",
    developmentTeam: [
      {
        name: "Zack Cornfield",
    ...
    featuresDeveloped: [
      {
        ...
        description:
          "Implemented secure user authentication using JWT and bcrypt for password hashing. Users can sign up, log in, and manage their accounts securely.",
        image: "./assets/images/Pulse/Auth.png",
      },
      {
        name: "Post and Feed System",
        description:
          "Developed a dynamic post system where users can create, edit, and delete posts. A real-time feed updates with new content from following.",
        image: "./assets/images/Pulse/Post.png",
      },
      {
        name: "Follow System",
        description:
          "Built a follow system allowing users to follow and unfollow each other, view followings' posts, and manage following.",
        image: "./assets/images/Pulse/Follow.png",
      },
      {
        name: "Likes and Interactions",
        description:
          "Added the ability to like posts, providing engagement features similar to major social media platforms.",
  ...
  },
  {
    ...
    type: "Personal Project",
    description:
      "A modern, responsive portfolio website built with React to showcase my projects, skills, and experience. Designed for easy navigation and scalability.",
    lastUpdated: "2025",
    developmentTeam: [
      {
        name: "Zack Cornfield",
    ...
    featuresDeveloped: [
      {
        ...
        description:
          "Designed the portfolio to feature individual project pages with detailed information. This allows for a more detailed breakdown of each project with images, links, and descriptions.",
        image: "./assets/images/Portfolio/Project-Pages.png",
      },
      {
        name: "Responsive Design",
        description:
          "Implemented a fully responsive layout to ensure the portfolio looks great on all devices, from desktops to mobile screens.",
        image: "./assets/images/Portfolio/Responsive.png",
      },
      {
        name: "Smooth Navigation",
        description:
          "Developed a clean and intuitive navigation system with smooth scrolling and animated transitions between sections.",
  ...
  },
  {
    ...
    description:
      "A Tinder-style restaurant discovery app that helps users decide where to eat through interactive matchups.",
    ...
    featuresDeveloped: [
      {
        name: "Interactive Restaurant Matchups",
        description:
          "Implemented a tournament-style selection system where users choose between two restaurants until a winner is determined.",
        image: "./assets/images/Swipe-n-Dine/MatchUp.png",
      },
      {
        name: "Google Maps Integration",
        description:
          "Integrated Google Places API to fetch restaurant data, photos, and details with real-time location-based searching.",
        image: "./assets/images/Swipe-n-Dine/Details.png",
      },
      {
        name: "Responsive UI/UX",
        description:
          "Designed mobile-first card components with smooth animations and intuitive swipe-like interactions.",
        image: "./assets/images/Swipe-n-Dine/UI.png",
      },
      {
        name: "Advanced Search Filters",
        description:
          "Built customizable filters for cuisine types, distance, ratings, and price levels with persistent state management.",
        image: "./assets/images/Swipe-n-Dine/Search.png",
      },
    ],
    fullDescription: `Swipe N Dine solves the common dilemma of "where should we eat?" by providing a fun, gamified way to discover restaurants. The application leverages Google's Places API to fetch real-time restaurant data based on user location and preferences. Users can filter by cuisine type, distance, rating, and price level before entering a tournament-style selection process where they choose between two options until a winner emerges. The tech stack includes React.js for the frontend, Node.js/Express for the backend API layer, and Google Cloud services for location data. The app features responsive design, session persistence, and optimized image loading to handle Google's API rate limits.`,
    skills: ["React.js", "Google Maps API", "Node.js/Express", "REST APIs"],
    links: {
      github: "https://github.com/ZackCornfield/Swipe-Dine",
      demo: "https://swipe-dine-1.onrender.com/",
    },
    image: "./assets/images/Swipe-n-Dine/MatchUp.png",
  },
  {
